...
import { a as useRuntimeConfig$1, d as defu } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    file: "/Users/detik/Project/extra/hope-idn/pages/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/index.eeac2d6a.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.06a6beb3.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
